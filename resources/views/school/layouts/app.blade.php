...
<head>
    ...
    <title>{{ config('app.name', 'Laravel') }} :: School</title>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    @if (Auth::guard('school')->guest())
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('school.login') }}">{{ __('Login') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('school.register') }}">{{ __('Register') }}</a>
                        </li>
                    @else
