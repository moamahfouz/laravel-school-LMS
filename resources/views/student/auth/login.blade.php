                            ...
                            <div class="p-5">
                                ...
                                <form method="POST" action="{{ route('student.login') }}" aria-label="{{ __('Login') }}">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            <input id="email" placeholder="Enter your Email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ (\Session::get('email')) ? Session::get('email') : ' ' }}" required autofocus>
                                ...
                                <hr>
                                <div class="text-center">
                                    <a class="small" href="/student/register">Register student</a>
                                </div>
                            </div>
                        </div>
                    </div>
